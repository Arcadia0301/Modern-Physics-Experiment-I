...
# 文件列表
files = [
    "Merged_Pos150mm_Air.txt",
    "Merged_Pos170mm_Air.txt",
    "Merged_Pos190mm_Air.txt",
    "Merged_Pos220mm_Air.txt",
    "Merged_Pos250mm_Air.txt",
    "Merged_Pos270mm_Air.txt"
]

colors = ["lightblue", "#FFC966", "lightgreen",
          "#FF9999", "plum", "tan"]
